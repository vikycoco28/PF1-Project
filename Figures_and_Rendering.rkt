...
(define (str->icon s)
  (cond
    ...
    [(string=? s "fill") FILL]
    [(string=? s "c1") (list-ref LOI 4)]
    [(string=? s "c2") (list-ref LOI 5)]
    [(string=? s "c3") (list-ref LOI 6)]
    [(string=? s "c4") (list-ref LOI 7)]
    [(string=? s "c5") (list-ref LOI 8)]
    [(string=? s "c6") (list-ref LOI 9)]
    [(string=? s "c7") (list-ref LOI 10)]
